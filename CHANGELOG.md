...
### Fixed
- **Critical: Heredoc handling** — Hook now properly handles multi-line git commit commands with heredocs (`<<'EOF'`)
- **Regex improvement** — Removed end-of-line anchor (`$`) that prevented matching multi-line commands
